...
public class AdvancedTTT {
  ...
  public static void play(int choice){
    ...
    if(choice == 'x' || choice == 'X'){        // if player choose x, player first
  ...
  public static Action_Advanced getMove(State_Advanced ss){
    ...
    System.err.println();
    // System.err.print("Time spent: ");
    // System.err.println(totalTime/1000000);   // calculation of step time, used for debug
    return move;
  }
