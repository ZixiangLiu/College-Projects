 ...
 * modified to add a negate constructor
 */
...
public class Literal {
    ...
    /*
     * negate constructor
     * construct an instance with different polarity
     * used in resolve function to generate negate of the literal
     */
    public Literal(Literal l) throws IllegalArgumentException{
      ...
      switch(l.getPolarity()){
        ...
        case NEGATIVE:
          ...
          break;
        default:
          throw new IllegalArgumentException("Ambiguous Polarity input.");
      }
    }
